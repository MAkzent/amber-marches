...
- Local files: `cc0/kaykit-medieval/`
...
- Creator: Admurin
- Source: https://admurin.itch.io/pixel-character
- Local pack index: `admurin-pixel-character/INDEX.md`
- Archived sheets: `heroes/{paladin,ranger,wizard,bard,cleric}/{idle,walk,run}.png`
- License: commercial use allowed inside a game project; do not redistribute or resell as standalone game assets; no NFTs; no AI training. Credit optional but appreciated.
...
- Local file: `audio/old-tower-inn.mp3`
- License: Creative Commons Zero 1.0 Universal
- Use: low-volume exploration music beneath the procedural wind, river and bird soundscape
